...
func (l *Labwork) GetAuthor() user.UserBase {
	return l.author
}

func (l *Labwork) GetName() string {
	return l.name
}

func (l *Labwork) GetDescription() string {
	return l.description
}

func (l *Labwork) GetCriterias() string {
	return l.criterias
}

func (l *Labwork) GetPoints() int {
	return l.points
}

func (l *Labwork) GetID() *generatorid.ID {
	return l.id
}

func (l *Labwork) GetBasicID() *generatorid.ID {
	if l.basic_id == nil {
		return nil
	}
	return l.basic_id
